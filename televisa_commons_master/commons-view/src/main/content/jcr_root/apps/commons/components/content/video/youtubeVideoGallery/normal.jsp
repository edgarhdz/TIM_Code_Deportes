 ...
 *  This component displays a youtube video gallery. It uses references to video pages to populate the video list.
...
<cq:include script="/apps/commons/components/content/video/players/youtube.jsp" />
