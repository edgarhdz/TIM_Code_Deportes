...
%><%@include file="/libs/foundation/global.jsp"%><%
    ...
    if (currentDesign != null) {
        ...
        if (WCMMode.fromRequest(request) == WCMMode.DISABLED) {
            ...
            %><cq:includeClientLib js="<%= xssAPI.encodeForHTMLAttr(libCategory) %>"/><%
        }
    }
%>
...
<cq:includeClientLib categories="deportes.tdOpinionBlog01"/>
<cq:includeClientLib categories="deportes.article"/>
<cq:includeClientLib categories="deportes.widgets"/>
<cq:includeClientLib categories="deportes.mix"/>
<cq:includeClientLib categories="deportes.navigation"/>
<cq:includeClientLib categories="deportes.structure"/>
