...
--%><%@ include file="/libs/foundation/global.jsp" %><%@page session="false" import="org.apache.commons.lang3.StringEscapeUtils"%><%
%><head>
...
<%-- Standard widgets styling if not below #CQ div --%>
<link rel="stylesheet" href="/etc/designs/geometrixx/ui.widgets.css" type="text/css">

<%-- Styling for forms, mostly copied from /etc/designs/geometrixx/static.css  --%>
<style type="text/css">
...
/*-FORMS- copied from /etc/designs/geometrixx/static.css */
