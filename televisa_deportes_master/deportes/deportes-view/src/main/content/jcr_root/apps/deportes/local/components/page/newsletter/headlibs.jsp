...
<cq:includeClientLib categories="deportes.tdNewsletter01"/>
...
<%
    ...
    request.setAttribute( "DAXName","deportes." + currentPage.getParent().getParent().getName() + "." + flattags +"." + opttags + ".newsletter." + currentPage.getParent().getName() + "-" + currentPage.getName() );
    request.setAttribute( "DFPTag", currentPage.getParent().getParent().getName() + "/" + flattags + "/newsletter" );
