...
<div class="nav_corft_newsletter_01">
    <footer>
        <div class="shortcut-home">
            <a href="http://www.televisa.com" title="Link description">
                <div class="nav_corft_newsletter_01_wrapper">
        ...
        <div class="dark-row">
            <div class="nav_corft_newsletter_01_wrapper legal">
                <div class="middle-row">
                    ...
                    <div class="middle-row">
                        <a href="${linkLogo}" title="${properties.titleLinkLogo}"
                           class="logo"> <span class="nav_corft_newsletter_01_sprite logo"></span>
                        </a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="right">
                        ...
                        <div class="nav_corft_newsletter_01_sprite_trade">
