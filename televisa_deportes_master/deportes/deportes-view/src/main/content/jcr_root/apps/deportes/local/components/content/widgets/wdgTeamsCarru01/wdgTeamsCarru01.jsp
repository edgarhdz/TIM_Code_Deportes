...
<!-- BEGIN: wdg_teams_carru_01 -->
<c:choose>
    <c:when test="${authorMode}">
        <div class="wdg_teams_carru_01" style="overflow: scroll;">
    </c:when>
    <c:otherwise>
        <div class="wdg_teams_carru_01">
    </c:otherwise>
</c:choose>
        ...
        <div class="ocultar">
            <c:choose>
                <c:when test="${empty currentStyle.btnText1}">
                    <a href="#"><i class="tvsa-caret-up"></i>[${altbtnText1}]</a>
                </c:when>
                <c:otherwise>
                    <a href="#"><i class="tvsa-caret-up"></i> ${currentStyle.btnText1}</a>
                </c:otherwise>
            </c:choose>
        ...
        <div class="mostrar">
            <c:choose>
                <c:when test="${empty currentStyle.btnText2}">
                    <a href="#"><i class="tvsa-caret-down"></i>[${altbtnText2}]</a>
                </c:when>
                <c:otherwise>
                    <a href="#"><i class="tvsa-caret-down"></i>${currentStyle.btnText2}</a>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="row">
            ...
            <div class="equipos">
                ...
                <cq:include path="imgTeamsCarru02ItemsContainer ItemHolderone" resourceType="foundation/components/parsys" />
            </div>
            ...
            <div class="equipos">
                ...
                <cq:include path="imgTeamsCarru02ItemsContainer ItemHoldertwoo" resourceType="foundation/components/parsys" />
            </div>
            ...
            <div class="equipos">
                ...
                <cq:include path="imgTeamsCarru02ItemsContainer ItemHolderthree" resourceType="foundation/components/parsys" />
            </div>
        ...
        <div class="row">
            ...
            <div class="equipos">
                ...
                <cq:include path="imgTeamsCarru02ItemsContainer ItemHolderfour" resourceType="foundation/components/parsys" />
            </div>
            ...
            <div class="equipos">
                ...
                <cq:include path="imgTeamsCarru02ItemsContainer ItemHolderfive" resourceType="foundation/components/parsys" />
            </div>
            ...
            <div class="equipos">
                ...
                <cq:include path="imgTeamsCarru02ItemsContainer ItemHoldersix" resourceType="foundation/components/parsys" />
            </div>
