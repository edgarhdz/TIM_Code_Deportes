CQ.form.VideoGallerySearch = CQ.Ext.extend(CQ.Ext.form.ComboBox, {
...
constructor : function(config) {
    ...
    validator : function(){
        ...
        if(!validation){
			isValid = CQ.I18n.getMessage("generics.searchfieldvalidation.video");
        }else{
			isValid = true;
        }
        return isValid;
...
CQ.Ext.reg("videogallerysearch", CQ.form.VideoGallerySearch); //Register the xtype